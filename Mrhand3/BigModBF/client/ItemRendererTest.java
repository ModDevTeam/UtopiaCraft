...
{
protected ModelDubGun sniperModel;
float scale = 0.7F;

public ItemRendererTest()
{
  sniperModel= new ModelDubGun();
}
...
public void renderItem(ItemRenderType type, ItemStack item, Object... data)
{
  ...
  case EQUIPPED:
  {
   ...
   GL11.glRotatef(30F, 0.0F, 1.0F, 0F);
   ...
   {
       GL11.glTranslatef(0.1F, 0.32F, 1.99F);
	   }
	   else
	   {
	    isFirstPerson = true;
   ...
   Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(BaseMod.modid + ":/textures/models/NewTexture.png"));
  ...
  case EQUIPPED_FIRST_PERSON:
  {
   ...
   GL11.glRotatef(30F, 0.0F, 1.0F, 0F);
   GL11.glRotatef(28000.0F, 0.0F, 0.0F, 1.0F);
   GL11.glTranslatef(0.1F, 0.32F, 1.70F);
