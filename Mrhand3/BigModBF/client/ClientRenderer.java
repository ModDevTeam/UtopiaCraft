...
public class ClientRenderer extends NetHandler
{
    ...
    public ClientRenderer(Minecraft par1Minecraft, String par2Str, int par3) throws IOException
    {
    ...
    public ClientRenderer(Minecraft par1Minecraft, String par2Str, int par3, GuiScreen par4GuiScreen) throws IOException
    {
        this.mc = par1Minecraft;
    ...
    public ClientRenderer(Minecraft par1Minecraft, IntegratedServer par2IntegratedServer) throws IOException
    {
        this.mc = par1Minecraft;
    ...
    public void handleGameEvent(Packet70GameEvent par1Packet70GameEvent)
    {
        ...
        {
            this.mc.displayGuiScreen(new GuiUtopia());
        }
        else if (i == 5)
        {
            GameSettings gamesettings = this.mc.gameSettings;
    ...
    {
        ClientRenderer.connectionCompatibilityLevel = connectionCompatibilityLevel;
    }
