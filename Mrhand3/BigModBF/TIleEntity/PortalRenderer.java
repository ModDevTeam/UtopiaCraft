...
import assets.bigmod.textures.models.herpies;
...
public class PortalRenderer extends TileEntitySpecialRenderer{
	...
	private herpies model;

    
    public PortalRenderer() {
            this.model = new herpies();
    }
   ...
   //Use in 1.6.2  this
            ResourceLocation textures = (new ResourceLocation("bigmod:textures/blocks/portalH.png")); 
    //the ':' is very important
    //binding the textures
            Minecraft.getMinecraft().renderEngine.bindTexture(textures);
            
            PortalEntity myTile = (PortalEntity) te;
