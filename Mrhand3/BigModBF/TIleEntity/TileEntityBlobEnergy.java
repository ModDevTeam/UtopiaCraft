...
public class TileEntityBlobEnergy extends TileEntity{
	...
	public TileEntityBlobEnergy(int maxEnergy)
	{
	...
	public void getEnergyTeleported()
	{
		...
		if(activeConnections[0]==1)
		{
			if(energyLevel<maxEnergyLevel-32)
			{
				...
				if(tile instanceof TileEntityBlobEnergy)
				{
					if(((TileEntityBlobEnergy) tile).getEnergyLevel()>32)
					{
						TileEntityBlobEnergy tile2 = (TileEntityBlobEnergy) worldObj.getBlockTileEntity(coords0[0], coords0[1], coords0[2]);
						if(tile2!=null)
						{
			...
			if(energyLevel<maxEnergyLevel-32)
			{
				...
				if(tile instanceof TileEntityBlobEnergy)
				{
					if(((TileEntityBlobEnergy) tile).getEnergyLevel()>32)
					{
						...
						TileEntityBlobEnergy tile2 = (TileEntityBlobEnergy) worldObj.getBlockTileEntity(coords1[0], coords1[1], coords1[2]);
						if(tile2!=null)
						{
							tile2.setEnergyLevel(tile2.energyLevel-32);
							setEnergyLevel(energyLevel+32/(efficiencyLevel));
		...
		if(activeConnections[2]==1)
		{
			if(energyLevel<maxEnergyLevel-32)
			{
				...
				if(tile instanceof TileEntityBlobEnergy)
				{
					if(((TileEntityBlobEnergy) tile).getEnergyLevel()>32)
					{
						TileEntityBlobEnergy tile2 = (TileEntityBlobEnergy) worldObj.getBlockTileEntity(coords2[0], coords2[1], coords2[2]);
						if(tile2!=null)
						{
							tile2.setEnergyLevel(tile2.energyLevel-32);
							setEnergyLevel(energyLevel+32/(efficiencyLevel));
		...
		if(activeConnections[3]==1)
		{
			if(energyLevel<maxEnergyLevel-32)
			{
				...
				if(tile instanceof TileEntityBlobEnergy)
				{
					if(((TileEntityBlobEnergy) tile).getEnergyLevel()>32)
					{
						TileEntityBlobEnergy tile2 = (TileEntityBlobEnergy) worldObj.getBlockTileEntity(coords3[0], coords3[1], coords3[2]);
						if(tile2!=null)
						{
							tile2.setEnergyLevel(tile2.energyLevel-32);
							setEnergyLevel(energyLevel+32/(efficiencyLevel));
		...
		if(activeConnections[4]==1)
		{
			if(energyLevel<maxEnergyLevel-32)
			{
				...
				if(tile instanceof TileEntityBlobEnergy)
				{
					if(((TileEntityBlobEnergy) tile).getEnergyLevel()>32)
					{
						TileEntityBlobEnergy tile2 = (TileEntityBlobEnergy) worldObj.getBlockTileEntity(coords4[0], coords4[1], coords4[2]);
						if(tile2!=null)
						{
							tile2.setEnergyLevel(tile2.energyLevel-32);
							setEnergyLevel(energyLevel+32/(efficiencyLevel));
