...
public void placeInPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
{
         ...
         else
         {
                 ...
                 this.worldServerInstance.setBlock(i, j, k, true ? BlockManager.StandOrb.blockID : 0);
...
public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
{
         ...
         else
         {
                 for (k1 = l - short1; k1 <= l + short1; ++k1)
                 {
                         ...
                         for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                         {
                                 ...
                                 {
                                         /** change this block **/
                                         if (this.worldServerInstance.getBlockId(k1, i2, l1) == BlockManager.StandOrb.blockID)
                                         {
                                                 /** change this block **/
                                                 while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == BlockManager.StandOrb.blockID)
                                                 {
                                                         --i2;
                                                 }
         ...
         if (d3 >= 0.0D)
         {
                 ...
                 int j2 = -1;
                 /** change this block **/
                 if (this.worldServerInstance.getBlockId(i - 1, j, k) == BlockManager.StandOrb.blockID)
                 {
                         j2 = 2;
                 }
                 /** change this block **/
                 ...
                 /** change this block **/
                 if (this.worldServerInstance.getBlockId(i, j, k - 1) == BlockManager.StandOrb.blockID)
                 {
                         j2 = 3;
                 }
                 /** change this block **/
