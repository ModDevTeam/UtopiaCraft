...
import cpw.mods.fml.relauncher.SideOnly;
	...
	public class Fossilizer extends BlockContainer{
		...
		public Fossilizer(int id, boolean isActive) {
		...
		public void registerIcons(IconRegister iconRegister){
			this.blockIcon = iconRegister.registerIcon(BaseMod.modid + ":" + "macerator_side");
			this.maceratorIconTop = iconRegister.registerIcon(BaseMod.modid + ":" + (this.isActive ? "macerator_front_lit" : "macerator_front_idle"));
		}*/
		...
		{
			return BlockManager.Machine1Idle.blockID;
		}   
		...
		public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
			if(!world.isRemote) {
				FMLNetworkHandler.openGui(player, BaseMod.instance, 173, world, x, y, z);
			}
		...
		public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
		{
			...
			if(!par0)
			{
				par1World.setBlock(par2, par3, par4, BlockManager.Machine1Idle.blockID);
			}
		...
		public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
		{
			...
			{
				((TEF)par1World.getBlockTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
			}
		}
		...
		public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
		{
			...
			{
				TEF TileEntityMacerator = (TEF)par1World.getBlockTileEntity(par2, par3, par4);
