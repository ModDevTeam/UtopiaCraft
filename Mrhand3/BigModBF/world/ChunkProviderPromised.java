...
import Mrhand3.BigModBF.worldgen.WorldGenTreeBlob1;
import Mrhand3.BigModBF.worldgen.WorldGenTreeBlob2;
import Mrhand3.BigModBF.worldgen.WorldGenTreeBlob3;
import Mrhand3.BigModBF.worldgen.WorldGenTreeBlob4;
...
public class ChunkProviderPromised implements IChunkProvider
{
	...
	public ChunkProviderPromised(World par1World, long par2, boolean par4)
	{
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
        ...
        if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, var11, LAKE) && !var11 && this.rand.nextInt(4) == 0)
        {
                ...
                {
                        (new WorldGenLakesBlob(BlockManager.HolyWaterF.blockID)).generate(this.worldObj, this.rand, var12, var13, var14);
                }
        }
        if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, var11, LAKE) && !var11 && this.rand.nextInt(4) == 0)
        {
        ...
        for (int k = 0; k < 1; k++)
        {
                ...
                (new WorldGenTreeBlob(false)).generate(worldObj, rand, RandPosX, RandPosY, RandPosZ);
        }
        for (int k = 0; k < 1; k++)
        {
                int RandPosX = var4 + rand.nextInt(16);
                int RandPosY = 55 + rand.nextInt(40);
                int RandPosZ = var5 + rand.nextInt(16);
                (new WorldGenTreeBlob1(false)).generate(worldObj, rand, RandPosX, RandPosY, RandPosZ);
        }
        for (int k = 0; k < 1; k++)
        {
                int RandPosX = var4 + rand.nextInt(16);
                int RandPosY = 55 + rand.nextInt(40);
                int RandPosZ = var5 + rand.nextInt(16);
                (new WorldGenTreeBlob2(false)).generate(worldObj, rand, RandPosX, RandPosY, RandPosZ);
        }
        for (int k = 0; k < 1; k++)
        {
                int RandPosX = var4 + rand.nextInt(16);
                int RandPosY = 55 + rand.nextInt(40);
                int RandPosZ = var5 + rand.nextInt(16);
                (new WorldGenTreeBlob3(false)).generate(worldObj, rand, RandPosX, RandPosY, RandPosZ);
        }
        for (int k = 0; k < 1; k++)
        {
                int RandPosX = var4 + rand.nextInt(16);
                int RandPosY = 55 + rand.nextInt(40);
                int RandPosZ = var5 + rand.nextInt(16);
                (new WorldGenTreeBlob4(false)).generate(worldObj, rand, RandPosX, RandPosY, RandPosZ);
        }
        for (int k = 0; k < 1; k++)
        {
                int RandPosX = var4 + rand.nextInt(16);
